...
class GeminiAPI:
    ...
    def configure(self):
        ...
        if not self.api_key:
            ...
            print("Warning: No Gemini API key configured. API calls will require an API key from UI.")
            return False
    ...
    def create_model(self, model_name="gemini-2.0-flash"):
        ...
        if not self.api_key:
            raise ValueError("No API key available. Please enter a valid Gemini API key in the application UI.")
